  ...
  return (
    <div className="max-w-5xl mx-auto px-4 pb-32 animate-fade-in">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-neutral-900 p-6 border-4 border-black shadow-[12px_12px_0px_#000]">
        ...
        <div className="md:col-span-3 relative min-h-[500px] border-4 border-black overflow-hidden bg-black shadow-[4px_4px_0_#000]">
          <img
            src={imgCaso04Top}
          ...
          <div className="relative z-10 p-6 h-full flex flex-col justify-between items-start">
            <div id="bubble4-1" className="bg-white text-black p-4 rounded-xl border-4 border-black font-bold max-w-xl mb-4 shadow-[4px_4px_0_#000] scale-0 origin-bottom-left text-xs md:text-base">
              “Última parada: Almoxarifado central. Uma lâmpada fluorescente e copos de vidro caíram no chão, espalhando estilhaços por toda parte. Deixar isso exposto é um crime contra a segurança da equipe de limpeza. Vamos aplicar o protocolo padrão!”
            </div>
        ...
        <div className="md:col-span-3 flex justify-center items-center py-4">
          <ProtocolGame 
            onSuccess={() => {
              solveCase('case4');
              alert("🎉 CASO ENCERRADO!\nParabéns, agente! Você seguiu os protocolos corretamente, evitou acidentes e concluiu o treinamento de descarte consciente!");
            }} 
          />
        </div>
